...
from jamasp.report.prompts.edit_report import EDIT_SCHEMA, build_edit_messages
from jamasp.report.spec import coerce_spec
...
async def edit_report_spec(
    ...
    messages = build_edit_messages(spec, datasets, instruction, locale)
    ...
    updated = coerce_spec(proposed, datasets)

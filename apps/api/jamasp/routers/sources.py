...
from jamasp.queue import JobQueue, get_queue
from jamasp.schemas.scan import ScanOut
from jamasp.schemas.source import (
    ConnectionTestRequest,
    ConnectionTestResult,
    SourceCreate,
    SourceOut,
)
from jamasp.security.crypto import encrypt, key_from_settings
...
async def test_connection(
    ...
    try:
        ...
        # A malformed connection string is the admin's most likely mistake, so it
        # gets the same legible treatment as a refused connection.
        return ConnectionTestResult(healthy=False, error=str(exc))

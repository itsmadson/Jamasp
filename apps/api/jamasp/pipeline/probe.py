...
async def probe_relationships(
    ...
    """Bounded on purpose: every probe is a query, and on a remote database an
    unbounded candidate list is what turns a scan into an outage. Declared foreign
    keys are free and already captured; this only fills gaps."""
    declared = {
